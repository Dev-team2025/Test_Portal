    ...
    const fetchResults = async () => {
        try {
            ...
            answers.forEach((ans) => {
                ...
                if (!userId || !question?._id || ans.setNumber !== question.set || ans.setNumber !== selectedSet) {
                    return;
                }
...
<thead className="bg-gray-100">
  <tr>
    ...
    {/* Total Marks column */}
    <th className="border p-2 text-green-600">Total Marks</th>
